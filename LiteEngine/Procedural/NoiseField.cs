...
namespace LiteEngine.Procedural
{
    /// <summary>
    /// Provides methods to create and manipulate noise
    /// </summary>
    public class NoiseField
    {
        ...
        /// Eg if the field contains 10 values: 1,1,2,3,4,4,4,5,6,6 the 80% value is 5
        /// </summary>
